...
- [IrrigBucket local-first clients](irrigbucket-localfirst-clients.md) — Metro workspace resolution, Expo Go managed sign-in, and SDK upgrade catalog/release-age pitfalls.
